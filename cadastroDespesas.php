        ...
        <form action="SCRIPTS/registroDespesas.php" autocomplete="off" method="POST">
          ...
          ?>
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorAereo' id='valorAereo' placeholder='AEREO' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeAereo' id='quantidadeAereo' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorAlmocoCliente' id='valorAlmocoCliente' placeholder='ALMOCO CLIENTE' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeAlmocoCliente' id='quantidadeAlmocoCliente' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorAlmocoMotorista' id='valorAlmocoMotorista' placeholder='ALMOCO MOTORISTA' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeAlmocoMotorista' id='quantidadeAlmocoMotorista' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorAutorizacaoTransporte' id='valorAutorizacaoTransporte' placeholder='AUTORIZACAO TRANSPORTE' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeAutorizacaoTransporte' id='quantidadeAutorizacaoTransporte' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorEscuna' id='valorEscuna' placeholder='VALOR DO ESCUNA' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeEscuna' id='quantidadeEscuna' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorEstacionamento' id='valorEstacionamento' placeholder='ESTACIONAMENTO' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeEstacionamento' id='quantidadeEstacionamento' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorGuia' id='valorGuia' placeholder='VALOR GUIA' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeGuia' id='quantidadeGuia' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorHospedagem' id='valorHospedagem' placeholder='HOSPEDAGEM' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeHospedagem' id='quantidadeHospedagem' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorImpulsionamento' id='valorImpulsionamento' placeholder='IMPULSIONAMENTO' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeImpulsionamento' id='quantidadeImpulsionamento' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorIngresso' id='valorIngresso' placeholder='VALOR DO INGRESSO' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeIngresso' id='quantidadeIngresso' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorKitLanche' id='valorKitLanche' placeholder='KIT LANCHE' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeKitLanche' id='quantidadeKitLanche' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorMarketing' id='valorMarketing' placeholder='MARKETING' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeMarketing' id='quantidadeMarketing' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorMicro' id='valorMicro' placeholder='VALOR DO MICRO' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeMicro' id='quantidadeMicro' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorOnibus' id='valorOnibus' placeholder='VALOR DO ONIBUS' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeOnibus' id='quantidadeOnibus' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorPulseira' id='valorPulseira' placeholder='PULSEIRA' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadePulseira' id='quantidadePulseira' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorSeguroViagem' id='valorSeguroViagem' placeholder='VALOR DO SEGURO VIAGEM' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeSeguroViagem' id='quantidadeSeguroViagem' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorServicos' id='valorServicos' placeholder='SERVIÇOS' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeServicos' id='quantidadeServicos' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorTaxi' id='valorTaxi' placeholder='TAXI' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeTaxi' id='quantidadeTaxi' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='valorVan' id='valorVan' placeholder='VALOR DO VAN' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-1'>
                    <input type='text' class='form-control' name='quantidadeVan' id='quantidadeVan' placeholder='QTD' value='1' onblur='calculoTotalDespesas()'>
                  </div>
                  <div class='col-sm-2'>
                ...
                <div class='form-row my-4'>
                  ...
                  <div class='col-sm-6'>
                    <input type='text' class='form-control' name='outros' id='outros' placeholder='OUTROS' value='0' onblur='calculoTotalDespesas()'>
                  </div>
                </div>
