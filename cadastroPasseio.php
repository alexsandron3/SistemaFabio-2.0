          ...
          <form action="SCRIPTS/registroPasseio.php" autocomplete="off" method="POST">
            <div class="form-row">
              <div class="col">
                ...
                <input type="text" class="block-form campos-de-texto form-control" name="nomePasseio" id="nomePasseio"
                  placeholder="" required="required" data-toggle="tooltip" data-placement="left" title="NOME DO PASSEIO"
            ...
            <div class="form-row my-4">
              <div class="col">
                ...
                <input type="text" class="block-form campos-de-texto form-control" name="localPasseio"
                  id="LocalPasseiolatinTextBox" data-toggle="tooltip" data-placement="left" title="LOCAL DO PASSEIO"
                  onkeydown="upperCaseF(this)">
              </div>
            </div>
            <div class="form-row my-4 justify-content-between">
              <div class="col-md-3">
                ...
                <input type="text" class="block-form campo-monetario form-control" name="valorPasseio" id="valorPasseio"
                  placeholder="VALOR DO PASSEIO" value="0" data-toggle="tooltip" data-placement="top"
                  title="VALOR DO PASSEIO">
              </div>
              <div class="col-md-3">
                <label class=" col-form-label text-dark" for="lotacao"> LOTAÇÃO:</label>
                <input type="number" min="1" max="200" class="block-form form-control" name="lotacao"
                  id="intLimitTextBox" placeholder="1-200" data-toggle="tooltip" data-placement="left"
                  title="LOTAÇÃO DO PASSEIO" required="required">
              </div>
              <div class="col-md-3">
                <label class=" col-form-label text-dark" for="idadeIsencao"> ISENÇÃO:</label>
                <input type="number" min="0" max="99" class="block-form form-control" name="idadeIsencao"
                  id="idadeIsencao" placeholder="0-99" data-toggle="tooltip" data-placement="left"
                  title="IDADE MÍNIMA PARA ISENÇÃO" required="required">
              </div>
            </div>
            <div class="form-row my-4">
              <div class="col-lg-6">
                <label class=" col-form-label text-dark mb-1 pt-3" for="dataPasseio">DATA DO PASSEIO:</label>
                <input type="date" class="block-form form-control col-lg-5 mt-4 pb-2" name="dataPasseio"
                  id="dataPasseio" required="required" onblur="verificaDataPasseio()" data-toggle="tooltip"
                  data-placement="left" title="DATA DE REALIZAÇÃO DO PASSEIO">
              </div>
              <div class="col-lg-6">
                <label class=" col-form-label text-dark" for="nomeCliente">ANOTAÇÕES: </label>
                <textarea class="form-control" name="anotacoesPasseio" id="anotacoesPasseio" rows="3"
                  data-toggle="tooltip" data-placement="left" title="ANOTAÇÕES DO PASSEIO"
                  onkeydown="upperCaseF(this)"></textarea>
              </div>
              <div class="col">
                ...
                <textarea class="form-control" name="itensPacote" id="itensPacote" rows="5" data-toggle="tooltip"
                  data-placement="left" title="Itens do pacote" onkeydown="upperCaseF(this)"></textarea>
              </div>
            </div>
            <div class="form-row my-4">
            ...
            <fieldset class='block-form form-group'>
              <div class='row'>
                ...
                <div class='col-sm-5 '>
                  <div class='col'>
                    <input class='form-check-input ' type='radio' name='statusPasseio' id='statusPasseioAtivo' value='1'
                      checked>
                  ...
                  <div class='col'>
                    <input class='form-check-input' type='radio' name='statusPasseio' id='statusPasseioInativo'
                      value='0'>
                ...
                <div class="col-lg-6">
                  ...
                  <input type="date" class="block-form form-control col-lg-5  pb-2" name="dataLancamentoPasseio"
