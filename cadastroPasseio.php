          ...
          <form action="SCRIPTS/registroPasseio.php" autocomplete="off" method="POST">
            ...
            <div class="form-row my-4">
              ...
              <label class=" col-form-label text-dark" for="nomeCliente">LOCAL: </label>
                <input  type="text" class="campos-de-texto form-control" name="localPasseio" id="LocalPasseiolatinTextBox" data-toggle="tooltip" data-placement="left" title="LOCAL DO PASSEIO">
              </div>
            </div>
            <div class="form-row my-4 justify-content-between">
              <div class="col-md-3">
                ...
                <input  type="text" class="campo-monetario form-control" name="valorPasseio" id="valorPasseio" placeholder="VALOR DO PASSEIO" value="0" data-toggle="tooltip" data-placement="top" title="VALOR DO PASSEIO">
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                ...
                <input  type="number" min="0" max="99" class="form-control" name="idadeIsencao" id="idadeIsencao" placeholder="0-99" data-toggle="tooltip" data-placement="left" title="IDADE MÍNIMA PARA ISENÇÃO" required="required">
              </div>
            </div>
            <div class="form-row my-4">
              <div class="col-lg-6">
