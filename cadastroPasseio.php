    ...
    <div class="container-fluid ">
      <form action="SCRIPTS/registroPasseio.php" autocomplete="off" method="POST">
        <div class="form-group row">
          <label class="col-sm-1 col-form-label" for="nomePasseio">NOME DO PASSEIO</label>
          <div class="col-sm-6">
            <input type="text" class="form-control" name="nomePasseio" id="" placeholder="NOME DO PASSEIO"
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" name="localPasseio" id="localPasseio" placeholder="LOCAL DO PASSEIO"
              onkeydown="upperCaseF(this)">
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" name="valorPasseio" id="valorPasseio" placeholder="VALOR DO PASSEIO"
              onkeydown="upperCaseF(this)">
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <input type="date" class="form-control col-sm-4" name="dataPasseio" id="dataPasseio">
          </div>
        </div>
