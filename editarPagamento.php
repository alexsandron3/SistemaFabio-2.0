...
$queryBuscaIdPagamento = "    SELECT DISTINCT c.nomeCliente, c.referencia, c.idadeCliente , p.idPasseio, p.nomePasseio, p.dataPasseio, pp.idPagamento, pp.transporte , pp.idPasseio, pp.valorPago, pp.valorVendido, 
                                  pp.previsaoPagamento, pp.anotacoes, pp.valorPendente, pp.statusPagamento, pp.seguroViagem, pp.taxaPagamento, pp.localEmbarque, pp.clienteParceiro, pp.historicoPagamento, pp.idCliente, pp.clienteDesistente, pp.opcionais, pp.numeroVagas, pp.valorContrato
          ...
          <form action="SCRIPTS/atualizaPagamento.php" method="post" autocomplete="OFF" onblur="calculoPagamento()">
            <div class="form-group-row">
              ...
              <div class='form-row my-4'>
                ...
                <div class='col-6'>
                  <input type='text' class='block-form campo-monetario form-control' name='valorVendido'
                    id='valorVendido' placeholder='VALOR VENDIDO' value='<?php echo $valorVendido ?>'
                    onblur="calculoPagamento()">
                </div>
              </div>
              <div class='form-row my-4'>
                <label class='col-sm-2 col-form-label' for='valorPago'>VALOR PAGO</label>
                <div class='col-6'>
                  <input type='text' class='block-form campo-monetario form-control' name='valorPago' id='valorPago'
                    placeholder='VALOR PAGO' value='<?php echo $valorPago ?>' onblur="calculoPagamento()"
                    readonly="readonly">
                </div>
                <div class='col-sm-2'>
                  <input type='text' class='block-form campo-monetario form-control' name='novoValorPago'
                    id='novoValorPago' placeholder='NOVO PAGAMENTO' value=' 0' onblur="gerarHistorico()">
                  <input type='hidden' class='form-control' name='valorAntigo' id='valorAntigo'
                    placeholder='valorAntigo' value='<?php echo $valorPago ?>' onblur="calculoPagamento()">
                  <input type='hidden' class='form-control' name='idCliente' id='idCliente' placeholder='idCliente'
              ...
              <div class='form-row my-4'>
                ...
                <div class='col-6'>
                  <input type='text' class='form-control' name='valorPendenteCliente' id='valorPendenteCliente'
                    placeholder='VALOR PENDENTE' value='<?php echo $valorPendente ?>' onblur="calculoPagamento()"
                    readonly='readonly'>
                </div>
              </div>
              <div class='form-row my-4'>
                ...
                <div class='col-6'>
                  <input type='text' class='block-form campo-monetario form-control' name='taxaPagamento'
                    id='taxaPagamento' value='<?php echo $taxaPagamento ?>' placeholder='TAXA DE PAGAMENTO'
                    onblur="calculoPagamento(); gerarHistorico()">
                </div>
              </div>
              <div class='form-row my-4'>
                <label class='col-sm-2 col-form-label' for='valorContrato'>VALOR DO CONTRATO</label>
                <div class='col-6'>
                  <input type='text' class='block-form campo-monetario form-control' name='valorContrato'
                    id='valorContrato' value='<?php echo $rowIdPagamento['valorContrato'] ?>' placeholder='VALOR DO
                  CONTRATO'>
                </div>
              </div>
              <div class='form-row my-4'>
                ...
                <div class='col-6'>
                  <input type='text' class='block-form campo-monetario form-control' name='numeroVagas' id='numeroVagas'
                    value='<?php echo $rowIdPagamento['numeroVagas'] ?>' placeholder='NUMERO DE VAGAS'>
                </div>
              </div>
              <div class='form-row my-4'>
                <label class='col-sm-2 col-form-label' for='localEmbarque'>LOCAL DE EMBARQUE</label>
                <div class='col-6'>
                  <input type='text' class='block-form  form-control' name='localEmbarque' id='localEmbarque'
                    placeholder='LOCAL DE EMBARQUE' value='<?php echo $localEmbarque ?>' required='required'
                    autocomplete='on' onkeydown="upperCaseF(this)">
                </div>
              </div>
              <div class='form-row my-4'>
              ...
              <div class='form-row my-4'>
                ...
                <div class='col-sm-3'>
                  <input type='text' class='block-form campos-de-texto form-control' name='meioTransporte'
                    id='meioTransporte' value='<?php echo $transporte   ?>' placeholder='TRANSPORTE' autocomplete='on'
              ...
              <div class='form-row my-4'>
                ...
                <div class='col-sm-1'>
                  <input type='text' class='block-form campo-monetario form-control' name='idadeCliente'
                    id='idadeCliente' placeholder='' value='<?php echo $idadeCliente ?>'>
                </div>
              </div>
              <input type='hidden' class='form-control' name='statusPagamento' id='statusPagamento'
                placeholder='statusPagamento'>

              <div class='form-row my-4'>
                <label class='col-sm-2 col-form-label' for='referenciaCliente'>REFERÊNCIA</label>
                <textarea class='text-area form-control ml-3' name='referenciaCliente' id='referenciaCliente' cols='60'
                  rows='3' disabled='disabled'
                  placeholder='INFORMAÇÕES'> <?php echo $rowIdPagamento['referencia'] ?></textarea>
              </div>
              ...
              <fieldset class='form-group'>
                ...
                <div class='block-form row'>
                  ...
                  <div class='col-sm-5'>
                    <div class='col'>
                      <input class='form-check-input' type='radio' name='seguroViagemCliente'
                        id='seguroViagemClienteSim' value='1' <?php echo $statusSeguroViagemtrue; ?>>
                    ...
                    <div class='col'>
                      <input class='form-check-input' type='radio' name='seguroViagemCliente'
                        id='seguroViagemClientenao' value='0' <?php echo $statusSeguroViagemfalse; ?>>
                ...
                <input type='hidden' class='form-control' name='idadeCliente' id='idadeCliente'
                  placeholder='idadeCliente' value='<?php echo $idadeCliente; ?>'>
                <input type='hidden' class='form-control' name='idPasseioSelecionado' id='idPasseioSelecionado'
                  placeholder='idPasseioSelecionado' value='<?php echo $idPasseio ?>'>
                <?php
                ...
                <div class='block-form row'>
                  ...
                  <div class='col-sm-5'>
                    <div class='col'>
                      <input class='form-check-input' type='radio' name='clienteDesistente' id='clienteDesistenteSim'
                        value='1' <?php echo $clienteDesistenteTrue ?>>
                      <label class='form-check-label' for='clienteDesistenteSim'>
                        SIM
                      </label>
                    </div>
                    <div class='col'>
                      <input class='form-check-input' type='radio' name='clienteDesistente' id='clienteDesistenteoNao'
                        value='0' <?php echo $clienteDesistenteFalse ?>>
                ...
                <div class='block-form row'>
                  ...
                  <div class='col-sm-5'>
                    <div class='col'>
                      <input class='form-check-input' type='radio' name='clienteParceiro' id='clienteParceiroSim'
                        value='1' <?php echo $clienteParceiroTrue ?>>
                      <label class='form-check-label' for='clienteParceiroSim'>
                        SIM
                      </label>
                    </div>
                    <div class='col'>
                      <input class='form-check-input' type='radio' name='clienteParceiro' id='clienteParceironao'
                        value='0' <?php echo $clienteParceiroFalse ?>>
              ...
              <div class='form-row my-4'>
                ...
                <textarea class='text-area form-control  ml-3' name='opcionais' id='opcionais' cols='20' rows='3'
                  maxlength='500'><?php echo $rowIdPagamento['opcionais'] ?></textarea>

              </div>
              <div class='form-row my-4'>
                <label class='col-sm-2 col-form-label' for='anotacoes'>ANOTAÇÕES</label>
                <textarea class='text-area form-control ml-3' name='anotacoes' id='anotacoes' cols='20' rows='3'
                  placeholder='ANOTAÇÕES' maxlength='500'> <?php echo $anotacoes ?></textarea>
                <label class='col-sm-2 col-form-label' for='anotacoes'>HISTÓRICO</label>
                <textarea class='form-control ml-3' name='historicoPagamento' id='historicoPagamento' cols='30' rows='3'
                  placeholder='historicoPagamento' maxlength='500'> <?php echo $historicoPagamento ?> </textarea>
                <textarea style='display:none;' class='form-control col-sm-3 ml-3' name='historicoPagamentoAntigo'
                  id='historicoPagamentoAntigo' cols='6' rows='3' placeholder='historicoPagamentoAntigo' maxlength='500'
                  disabled='disabled'
                  onblur='(new calculoPagamentoCliente()).novoValorPago()'> <?php echo $historicoPagamento ?> </textarea>
              </div>
