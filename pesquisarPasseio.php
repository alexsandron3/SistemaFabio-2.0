                ...
                ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <?php echo "<a data-toggle='tooltip' data-placement='top' title='LUCROS' class='btn btn-success btn-just-icon btn-sm' target='_blank' rel='noopener noreferrer' href='relatoriosPasseio.php?id="  . $valorPesquisaPasseio['idPasseio'] . "' ><i class='material-icons'>price_check</i></a>"; ?>
                        <?php echo "<a data-toggle='tooltip' data-placement='top' title='RELATÓRIOS DO PASSEIO' class='btn btn-dark btn-just-icon btn-sm' target='_blank' rel='noopener noreferrer' href='relatoriosDoPasseio.php?id="  . $valorPesquisaPasseio['idPasseio'] . "' ><i class='material-icons'>summarize</i></a>"; ?>
