<?php
    ...
    $getData = "UPDATE pagamento_passeio SET    
                valorVendido='$valorVendido', valorPago='$valorPago', previsaoPagamento='$previsaoPagamento', sinalCliente='$sinalCliente', statusPagamento='$statusPagamento', valorPendente='$valorPendente', seguroViagem='$seguroViagemCliente',
