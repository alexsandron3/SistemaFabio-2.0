$(document).ready(function () {
    ...
    $('#tabelaListaRelatoriosPasseio').DataTable({
...
$(document).ready(function () {
    var table = $('#tabelaListaRelatoriosPasseio').DataTable();
    ...
    $("#hide_show_all").on("change", function () {
        ...
        if (hide) {
            $('#tabelaListaRelatoriosPasseio tr th').hide(100);
            $('#tabelaListaRelatoriosPasseio tr td').hide(100);
        } else {
            $('#tabelaListaRelatoriosPasseio tr th').show(100);
            $('#tabelaListaRelatoriosPasseio tr td').show(100);
        }
    });
    ...
    $(".hide_show").on("change", function () {
        ...
        $('#tabelaListaRelatoriosPasseio tr').each(function () {
            if (hide) {
