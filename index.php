...
<body>
   ...
   <!-- <p class='h4 text-center alert-info'> SELECIONE O INTERVALO</p> -->
    <form action='' method='GET' autocomplete='OFF'>
      <div class='form-group row mb-5 mt-5'>
        ...
        <input type='date' class='form-control col-sm-2' name='inicioDataPasseio' id='inicioDataPasseio'>

        <label class='col-sm-2 col-form-label  pl-5' for='fimDataPasseio'>PERÍODO</label>
        <input type='date' class='form-control col-sm-2' name='fimDataPasseio' id='fimDataPasseio' >
  ...
  <table class="table table-hover">
    ...
    <?php
      ...
      if(empty($inicioDataPasseio)OR empty($fimDataPasseio)){
        echo"<p class='h4 text-center alert-warning'> SELECIONE UM PERÍODO</p>";  
      }else{
  ...
  <tbody>
    <tr>
      ...
      <td data-toggle="tooltip" data-placement="top" title="<?php echo "RESERVADOS NA ÚLTIMA HORA: ".$confirmadosUltimaHora ?>" class="text-center"><span class="<?php echo $statusConfirmados ?>"><?php echo "         ".$confirmados ?></span></td>
      <td data-toggle="tooltip" data-placement="top" title="<?php echo "INTERESSADOS NA ÚLTIMA HORA: ".$interessadosUltimaHora ?>" class="text-center"> <span class="<?php echo $statusInteressados ?>"><?php echo"         ". $interessado ?> </span></td>
      <td data-toggle="tooltip" data-placement="top" title="<?php echo "PARCEIROS NA ÚLTIMA HORA: ".$parceirosUltimaHora ?>" class="text-center"><span class="<?php echo $statusParceiros  ?>"><?php echo "         ".$parceiro ?></span></td>
      <td data-toggle="tooltip" data-placement="top" title="<?php echo "CRIANCAS NA ÚLTIMA HORA: ".$criancasUltimaHora ?>" class="text-center"><span class="<?php echo $statusCriancas ?>"><?php echo "         ".$crianca ?></span></td>
