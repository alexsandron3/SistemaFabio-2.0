$(document).ready(function () {
    ...
    $('#tabelaPesquisarPasseio').DataTable({
...
$(document).ready(function () {
    var table = $('#tabelaPesquisarPasseio').DataTable();
    ...
    $("#hide_show_all").on("change", function () {
        ...
        if (hide) {
            $('#tabelaPesquisarPasseio tr th').hide(100);
            $('#tabelaPesquisarPasseio tr td').hide(100);
        } else {
            $('#tabelaPesquisarPasseio tr th').show(100);
            $('#tabelaPesquisarPasseio tr td').show(100);
        }
    });
    ...
    $(".hide_show").on("change", function () {
        ...
        $('#tabelaPesquisarPasseio tr').each(function () {
            if (hide) {
