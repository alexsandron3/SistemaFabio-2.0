...
- [ ] **CASO VOCÊ CADASTRE O PAGAMENTO DE UM CLIENTE SEM ANTES TER CADASTRADO UMA DESPESA, OS VALORES DE SEGURO VIAGEM PODERÃO SER CALCULADOS INCORRETAMENTE** *SERÁ CRIADA UMA VERIFICAÇÃO POSTERIORMENTE*
