...
## FUNCIONALIDADES PLANEJADAS POR ORDEM DE PRIORIDADE
 ...
 4. VERIFICAÇÃO NA HORA DA ATUALIZAÇÃO DE DADOS DO USUÁRIO SE JÁ EXISTE UM CLIENTE COM O CPF INSERIDO
 5. LISTAGEM DE PASSEIO (LISTA COM OS INTEGRANTES DE UM PASSEIO)
 6. QUALQUER OUTRO RELATÓRIO QUE FOR SOLICITADO
 7. INTEGRAÇÃO COM A RF PARA VERIFICAÇÃO DE CPF
