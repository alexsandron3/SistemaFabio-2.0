...
- [X] RELATÓRIOS COM BASE NAS DATAS ESCOLHIDAS
...
## V0.1.4 | 27.11.2020
 * ### PAGAMENTO
   * AGORA OS CÁLCULOS DO PAGAMENTO SÃO FEITOS A PARTIR DO SQL E NÃO DO PHP
   * REMOVIDO CAMPO *SINAL CLIENTE*
   * ADICIONADO CAMPO *ANOTAÇÕES*
 * #### RELATÓRIOS
   * AGORA VOCÊ PODE VER OS RELATÓRIOS FINANCEIROS PARA UM PASSEIO EM ESPECÍFICO OU PARA VÁRIOS PASSEIOS EM UM PERÍODO DE DATA SELECIONADO
 * ### CLIENTES
   * AGORA VOCÊ PODE CADASTRAR VÁRIOS CLIENTES COM O MESMO CPF DESDE QUE NÃO TENHO O MESMO NOME
 * ### DESPESAS
   * ADICIONADO CAMPO *QUANTIDADE* PARA TODOS OS ITENS DE DESPESAS
     * AGORA VOCÊ IRÁ ADICIONAR O VALOR UNITÁRIO DA DESPESAS E ENTÃO A QUANTIDADE DE CADA DESPESA, O SISTEMA IRÁ CALCULAR AUTOMATICAMENTE
